...
function register_anfitria_category_widget() {
    register_widget( 'AnfitriaCategory' );
}

add_action( 'widgets_init', 'register_anfitria_category_widget' );

/**
 * Adds Foo_Widget widget.
 */
class AnfitriaCategory extends WP_Widget {

	/**
	 * Register widget with WordPress.
	 */
	function __construct() {
		 parent::WP_Widget('anfitriacategory', $name = 'Anfitria Category', array('description' => __('Use este widget para exibir todas categorias e sub categorias.', 'text_domain')));
	}
