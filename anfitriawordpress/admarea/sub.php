...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL1 = sprintf("INSERT INTO `wp_term_taxonomy` (`term_taxonomy_id`, `term_id`, `taxonomy`, `description`, `parent`, `count`) VALUES (%s, %s, 'category', 'category', %s, '0')",
  		       GetSQLValueString($id, "int"),
  		       GetSQLValueString($id, "int"),
  		       GetSQLValueString($_GET['categoria'], "int"));
...
mysql_select_db($database_BLOG_MATRIZ, $BLOG_MATRIZ);
$query_mostra_categoria = "SELECT * FROM wp_terms WHERE term_id IN (SELECT term_id FROM wp_term_taxonomy WHERE parent = ".$_GET['categoria'].") ORDER BY name ASC";
