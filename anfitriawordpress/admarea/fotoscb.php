     ...
     Upload Foto:
      ...
      <td width="17%" align="center" nowrap="nowrap"><a href="fotox.php">
        <select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('self',this,1)">
          ...
          <option value="fotoscb.php" selected="selected">S/ Carimbo + Ass Branco</option>
        </select>
      </a></td>
    </form>
...
<?php do { ?>
  ...
  <div style="padding:5px; FLOAT:left; width:100px;"><img src="../uploads/marcab.php?show=<?php echo $row_mostra_fotos['foto_nome']; ?>" class="superwidth" style="padding:5px;"><img src="del.gif" width="109" height="18" border="0" usemap="#Map<?php echo $row_mostra_fotos['foto_id']; ?>" />
