     ...
     Upload Foto:
      ...
      <td width="17%" align="center" nowrap="nowrap"><a href="fotox.php">
        <select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('self',this,1)">
          ...
          <option value="fotoz.php" selected="selected">Assinatura Preto</option>
...
<?php do { ?>
  ...
  <div style="padding:5px; FLOAT:left; width:100px;"><img src="../uploads/marcaz.php?show=<?php echo $row_mostra_fotos['foto_nome']; ?>" border="1" class="superwidth" style="border-color:#CCC; padding:5px;"><img src="del.gif" width="109" height="18" border="0" usemap="#Map<?php echo $row_mostra_fotos['foto_id']; ?>" />
