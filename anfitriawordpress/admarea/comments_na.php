...
?>
<meta http-equiv="refresh" content="1;URL=<?php echo get_option('siteurl');?>/admarea" />
<?php
}
...
$query_comments = "SELECT * FROM wp_comments WHERE comment_parent = 0 and comment_approved = 0 ORDER BY comment_ID DESC";
