    ...
    <form name="form3" enctype="multipart/form-data" method="POST" action="<?php echo $editFormAction; ?>">
      ...
      <td width="17%" align="center" nowrap="nowrap"><a href="fotox.php">
        <select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('self',this,1)">
          ...
          <option value="fotoy.php" selected="selected">S/ Carimbo e Contorno</option>
...
<?php do { ?>
  ...
  <div style="padding:5px; FLOAT:left; width:100px;"><img src="../uploads/<?php echo $row_mostra_fotos['foto_nome']; ?>" class="superwidth" style="padding:5px;" /><img src="del.gif" width="109" height="18" border="0" usemap="#Map<?php echo $row_mostra_fotos['foto_id']; ?>" />
